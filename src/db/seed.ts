...
async function seed() {
	...
	try {
		...
		const publishedArticles = articleIds.slice(0, 40); // Only comment on published articles
		...
		// Seed article likes (300-500 likes)
		...
		// Seed article bookmarks (150-250 bookmarks)
		...
		console.log(`   - ${likeSet.size} likes`);
		console.log(`   - ${bookmarkSet.size} bookmarks`);
	} catch (error) {
